...
temp_plot = ggplot(ironton, aes(x = ironton$X_00060_00003 , y = ironton$X_99133_00003, col=Month)) +
  ...
  scale_x_log10(breaks = trans_breaks("log10", function(x) 10^x),
                labels = trans_format("log10", math_format(10^.x)), limits=c(10^3.0, 10^6)) +
  annotation_logticks()
temp_plot
ggsave(temp_plot, file=paste0("plot_norm_", "03216070_all_plot.pdf"), width = 14, height = 10, units = "cm", useDingbats=FALSE)
